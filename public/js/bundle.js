...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHJpdmVkaCIsImEiOiJjazhkNWdpMWwwcXN6M210NzFqcGRrdWM4In0.puzDvYfQd6sJ0G6vWjueYA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/trivedh/ck8d5qzgn1y9m1ilaoa25pvnn',
    scrollZoom: false //   center: [-118.11, 34.111],
    //   zoom: 10,
    //   interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; //   Add the marker to map
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_IDK37aAFZkw0e4C0BfPuIInW00UjBeJywi');
            _context.prev = 1;
            _context.next = 4;
